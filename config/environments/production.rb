Rails.application.configure do
  ...
  config.paperclip_defaults= {
    ...
    aliyun: {
      ...
      oss_host: "oss.wx-wcpc.getstore.cn",  # aliyun oss host
      img_host: "oss.wx-wcpc.getstore.cn",  # aliyun image service host
  ...
  # config.active_job.queue_name_prefix = "wcpc_#{Rails.env}"
